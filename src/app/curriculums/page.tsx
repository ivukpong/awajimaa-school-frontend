...
import { BookOpen, Lock, ChevronRight, FileText, Globe } from "lucide-react";
      ...
      <section className="bg-brand-navy text-white py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-4xl font-extrabold mb-3">
            National &amp; Regional Curriculums
          </h1>
          <p className="text-gray-300 text-lg">
            Access approved national and regional curriculum frameworks
            published by Ministries of Education.
          </p>
        </div>
      </section>
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-20">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-10 max-w-md w-full text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">
            Sign in to access curriculums
          </h2>
          <p className="text-gray-500 mb-6">
            Curriculum documents are available to registered schools, teachers,
            and ministry officials on the platform.
          </p>
          ...
          {[
            {
              ...
              desc: "Curriculum documents approved by national and state ministries.",
            },
            {
              icon: Globe,
              title: "Multi-Level Coverage",
              desc: "Early childhood through secondary school levels covered.",
            },
            {
              icon: BookOpen,
              title: "Always Up-to-Date",
              desc: "Ministries publish revisions directly on the platform.",
            },
