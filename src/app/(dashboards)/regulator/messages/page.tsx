...
export default function RegulatorMessagesPage() {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Communications with schools &amp; administrators
          </p>
        </div>
        <Button
        ...
        <div className="lg:col-span-2 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden flex flex-col">
          {compose ? (
            <div className="flex-1 p-6 space-y-4">
              ...
              <Input
                placeholder="To (school admin / name)"
                value={form.to}
              ...
              <textarea
                ...
                className="w-full min-h-[150px] rounded-lg border border-gray-200 dark:border-gray-700 bg-transparent p-3 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-brand"
              />
