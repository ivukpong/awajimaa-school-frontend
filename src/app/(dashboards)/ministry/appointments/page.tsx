...
const emptyForm = {
  ...
  location: "",
  meeting_url: "",
  bookable_type: "ministry",
  bookable_id: 0 as number,
};
...
export default function MinistryAppointmentsPage() {
  ...
  // Ministry users: fetch appointments where they are the booker (booker_id)
