            ...
            <div>
              ...
              <div className="space-y-1.5">
                {invoice.payments.map((p) => (
                  <div
                    key={p.id}
                    className="flex items-center justify-between text-xs bg-white dark:bg-gray-800 rounded px-3 py-2"
                  >
                    <div className="flex items-center gap-2">
                      <Clock size={12} className="text-gray-400" />
                      <span className="text-gray-600 dark:text-gray-300">
                        {p.payer_name ?? "Student"} ·{" "}
                        {p.payer_type === "third_party"
                          ? "Third Party"
                          : "Self"}
                      </span>
                    </div>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">
            Share this link so friends, family, or sponsors can pay your fees
            directly.
          </p>
