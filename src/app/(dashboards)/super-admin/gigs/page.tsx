    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">
          All freelance gigs and parent-hired teaching sessions
        </p>
      </div>
