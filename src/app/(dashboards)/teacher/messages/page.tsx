    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Inbox &amp; Sent</p>
        </div>
        <Button
              ...
              >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-brand dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                  />
                </div>
