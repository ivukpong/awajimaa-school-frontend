...
import { Library, Lock, BookMarked, Search, Award } from "lucide-react";
      ...
      <section className="bg-brand-navy text-white py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-lg">
            Access thousands of approved educational texts, reference books, and
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-20">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-10 max-w-md w-full text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">
            Sign in to read &amp; download books
          </h2>
          <p className="text-gray-500 mb-6">
            The E-Library is available to students, teachers, and school
      ...
      <section className="bg-white border-t border-gray-100 py-12 px-4">
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
          {[
            {
              icon: BookMarked,
              title: "Ministry-Approved Texts",
              desc: "Only books reviewed and approved by educational authorities appear in the library.",
            },
            {
              icon: Search,
              title: "Full-Text Search",
              desc: "Find exactly what you need with powerful search across titles, authors, and topics.",
            },
            {
              icon: Award,
              title: "Free for Students",
              desc: "Students enrolled in registered schools get free access to all core textbooks.",
            },
